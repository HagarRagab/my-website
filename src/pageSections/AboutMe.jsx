        ...
        <Section id="about" className={styles.aboutMe}>
            <motion.div style={{ opacity }}>
                ...
                <p>
                    ...
                    years of self-directed learning in web development, I bring
                    a unique blend of creativity and technical expertise. Eager
                    to create user-focused, visually engaging applications while
