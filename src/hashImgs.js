...
export const hashImgs = {
    about: {
        dark: {
            src: aboutMeImgDarkMood,
            mobSrc: aboutMeImgDarkMoodMobile,
            hash: "L5OpupV?%j%$_Mt7ofkCu5tRQ+Mc",
            alt: "About me in light color",
        },
        light: {
            src: aboutMeImgLightMood,
            mobSrc: aboutMeImgLightMoodMobile,
            hash: "L9NwK4s,?wXT%Mt6xuWCtntRR4IA",
            alt: "About me in dark color",
        },
    },
    education: {
        dark: {
            src: educationImgDarkMood,
            mobSrc: educationImgDarkMoodMobile,
            hash: "L7OWmJ-.%i_N-;M{xu%Mtn4.r:R5",
            alt: "Certifications in light color",
        },
        light: {
            src: educationImgLightMood,
            mobSrc: educationImgLightMoodMobile,
            hash: "LJLqRvD%%Nx]bHRjt7xu~qR*xZ%2",
            alt: "Certifications in dark color",
        },
    },
    contact: {
        dark: {
            src: contactImgDarkMood,
            mobSrc: contactImgDarkMoodMobile,
            hash: "L5O:%}i^.At-_MxtV^RlX;%fH=H?",
            alt: "Sending messages in light color",
        },
        light: {
            src: contactImgLightMood,
            mobSrc: contactImgLightMoodMobile,
            hash: "LANTm}IU%h_Nx]M{%M%f?wE1$yxC",
            alt: "Sending messages in dark color",
        },
    },
};
